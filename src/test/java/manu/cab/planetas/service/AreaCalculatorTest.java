...
public class AreaCalculatorTest {
	...
	public void test2() {
		...
		for(int n = 1; n < 365*10; n++) {
			double perimetroPlanet = ac.perimetro(n, pA, pB, pC);
			...
			if(Math.signum(areaPlanet) != signumPrevPlanet && Math.signum(areaPlanet) != 0f) {
				...
				System.out.println("Planeta a: " + pA.getPoint2D(n));
				System.out.println("Planeta b: " + pB.getPoint2D(n));
				System.out.println("Planeta c: " + pC.getPoint2D(n));
				*/
